...
class GroupContentGrid extends StatefulWidget {
  ...
  @override
  _GroupContentGridState createState() => _GroupContentGridState();
}


class _GroupContentGridState extends State<GroupContentGrid> {
  List categoryData = [];
